...
class DDSProfilesFromDiscoveryConfig:
    ...
    def _check_valid_config(cls, discovery_config: DiscoveryConfig):
        discovery_types = set(discovery_config.network_interface_to_discovery_type.values())
    ...
    @classmethod
    def _add_disable_multicast_item(cls, root, network_interface_to_discovery_type):
        discovery_types = set(network_interface_to_discovery_type.values())
    ...
    def profiles_from_discovery_config(
        ...
        for address, discovery_type in discovery_config.network_interface_to_discovery_type.items():
        ...
        if discovery_config.initial_peers:
            ...
            for peer_addr in discovery_config.initial_peers:
                peers.append(cls._PEER_XML_ITEM.format(peer_addr))
        ...
        cls._add_disable_multicast_item(
            profiles_file, discovery_config.network_interface_to_discovery_type)
