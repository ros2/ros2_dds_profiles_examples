...
def check_valid_network_interface_or_address(network_interface_or_address):
...
def check_valid_network_interfaces_or_addresses(network_interfaces_or_addresses):
    ...
    results = [
        check_valid_network_interface_or_address(interface_or_address)
        for interface_or_address in network_interfaces_or_addresses_list
    ]
    return all(results)


def to_address(network_interface_or_address):
    if not network_interface_or_address in ni.interfaces():
...
def to_addresses(network_interfaces_or_addresses):
    network_interfaces_or_addresses_list = comma_separated_to_list(
        network_interfaces_or_addresses)
    return [
        to_address(network_interface_or_address) for network_interface_or_address
